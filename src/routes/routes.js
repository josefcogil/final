...
const verificar = require('../controllers/verify');
...
routes.get('/galery', galery.galery, (req, res)=>{
    res.render('galerys');
});

routes.get('/images', verificar.verificar ,(req, res) => {
    res.render('imgAdd', { admin: true })
});

routes.get('/users', verificar.verificar ,(req, res) => {
